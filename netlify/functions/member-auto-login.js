// Success URL del checkout de membresía general: confirma que el pago se
// completó y genera una sesión de Supabase directamente (sin pasar por el
// email) para que la nueva miembro caiga ya logueada en preventa.html.
//
// El webhook (stripe-webhook.js) sigue guardando la fila en Supabase y
// mandando un magic link de respaldo, útil para logins futuros.
//
// Variables de entorno necesarias:
//   STRIPE_SECRET_KEY, SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY

const SITE_URL = "https://fraccctal.com";
const FALLBACK = `${SITE_URL}/membresia.html?miembro=ok`;
